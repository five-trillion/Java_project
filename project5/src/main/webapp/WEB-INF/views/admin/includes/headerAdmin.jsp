...
<!-- ======= Header ======= -->
	<header id="header" class="header fixed-top d-flex align-items-center">
		...
		<div class="d-flex align-items-center justify-content-between">
			<a href="adminHome" class="logo d-flex align-items-center"> <img
				src="${contextPath}/resources/assets/img/logo.png" alt=""> <span
			...
			<ul class="d-flex align-items-center">
				...
				<!-- End Messages Icon -->
					...
					<ul
						...
						<li class="message-item"><a href="#"> <img
								src="${contextPath}/resources/assets/img/messages-1.jpg" alt="" class="rounded-circle">
								<div>
									<h4>Maria Hudson</h4>
						...
						<li class="message-item"><a href="#"> <img
								src="${contextPath}/resources/assets/img/messages-2.jpg" alt="" class="rounded-circle">
								<div>
									<h4>Anna Nelson</h4>
									<p>Velit asperiores et ducimus soluta repudiandae labore
										officia est ut...</p>
						...
						<li class="message-item"><a href="#"> <img
								src="${contextPath}/resources/assets/img/messages-3.jpg" alt="" class="rounded-circle">
								<div>
									<h4>David Muldon</h4>
									<p>Velit asperiores et ducimus soluta repudiandae labore
										officia est ut...</p>
				...
				<li class="nav-item dropdown pe-3"><a
					...
					href="#" data-bs-toggle="dropdown"> <img
						src="${contextPath}/resources/assets/img/profile-img.jpg" alt="Profile"
