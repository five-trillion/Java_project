...
<link href="${contextPath}/resources/assets/vendor/boxicons/css/boxicons.min.css"
	rel="stylesheet">
<link href="${contextPath}/resources/assets/vendor/quill/quill.snow.css" rel="stylesheet">
<link href="${contextPath}/resources/assets/vendor/quill/quill.bubble.css" rel="stylesheet">
<link href="${contextPath}/resources/assets/vendor/remixicon/remixicon.css" rel="stylesheet">
<link href="${contextPath}/resources/assets/vendor/simple-datatables/style.css" rel="stylesheet">

<!-- Template Main CSS File -->
<link href="${contextPath}/resources/assets/css/style.css" rel="stylesheet">
<link href="${contextPath}/resources/assets/css/adminStyle.css" rel="stylesheet">
<!-- =======================================================
