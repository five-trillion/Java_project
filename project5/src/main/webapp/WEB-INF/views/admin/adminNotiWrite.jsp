...
<body>
	...
	<main id="main" class="main">
		...
		<div class="row">
			<form name="notiWrite" action="adminNotiWrite" method="post" enctype="multipart/form-data" role="form" onsubmit="return writeCheck();">
                <div class="row mb-3">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <textarea rows="10" class="form-control" id="boardContent" name="boardContent" maxlength="1000"></textarea>
                  </div>
                </div>
                <div class="row mb-3">
                  <label for="boardImgMulti" class="col-sm-2 col-form-label">게시판 이미지</label>
                  <div class="col-sm-10">
                    <input class="form-control" type="file" name="boardImgMulti" id="boardImgMulti">
                  </div>
                </div>
	...
	<script>
		...
		$(".btnBox").children().css({"margin-right": "20px"});
		function writeCheck() {
