				...
				<div class="col-lg-8 col-md-6 joinBox">
					...
					<div class="checkout__input">
						...
						<input type="password" name="userPw"
							placeholder="영문과 숫자, 특수문자를 조합하여 6~16자로 입력해주세요." required>
					</div>
					<div class="checkout__input">
						<p>
							비밀번호 확인<span>*</span>
					...
					<div class="checkout__input">
						...
						<div class="phoneBox">
							...
							<input list="email2List" id="email2" name="email2" required
								placeholder="직접입력"> <input type="hidden" name="email"
								id="email">
						</div>
					</div>
					<div class="checkout__input">
					...
					<div class="checkout__input">
						...
						<input type="text" id="nick" name="nick"
							placeholder="사용하실 닉네임을 8글자 이내로 입력해주세요.">
					</div>
					<div class="checkout__input">
						<p>생년월일</p>
						<input type="text" id="inputBirth" name="inputBirth"
							placeholder="생년월일 8자리를 입력해주세요. ex)19951128"> <input
							type="hidden" id="birth" name="birth">
					</div>
					<div class="checkout__input__checkbox">
						<label for="checkboxAll"> <span
							style="color: black; font-weight: bold;">이용약관, 개인정보 수집 및
								이용에 모두 동의합니다.</span> <input type="checkbox" id="checkboxAll"
							name="checkboxAll" onchange="checkAll()"> <span
							class="checkmark"></span>
						</label>
					</div>
					<div class="checkout__input__checkbox">
						<label for="checkbox1" id="labelCheckbox1"> <span
							style="color: black;">[필수] 이용약관 동의</span> <input type="checkbox"
							id="checkbox1" name="checkbox1"> <span class="checkmark"></span>
							<span
							style="color: black; text-decoration: underline; cursor: pointer; text-align: right;"
							onclick="toggleTerms('termsContent1', 'checkbox1')">약관보기</span>
						</label>
					</div>
					<div id="termsContent1" style="display: none;">
						제1조(목적)<br> 이 약관은 이삼오구 회사(전자상거래 사업자)가 운영하는 픈픈 사이버 몰(이하 “몰”이라
						한다)에서 제공하는 인터넷 관련 서비스(이하 “서비스”라 한다)를 이용함에 있어 사이버 몰과 이용자의 권리.의무 및
						책임사항을 규정함을 목적으로 합니다.<br> ※「PC통신, 무선 등을 이용하는 전자상거래에 대해서도 그 성질에
						반하지 않는 한 이 약관을 준용합니다.」<br> 제2조(정의)<br> ① “몰”이란 이삼오구 회사가
						...
						말합니다.<br> 제3조 (약관 등의 명시와 설명 및 개정)<br> ① “몰”은 이 약관의 내용과
						상호 및 대표자 성명, 영업소 소재지 주소(소비자의 불만을 처리할 수 있는 곳의 주소를 포함),
						전화번호.모사전송번호.전자우편주소, 사업자등록번호, 통신판매업 신고번호, 개인정보보호책임자등을 이용자가 쉽게 알 수
						있도록 픈픈 사이버몰의 초기 서비스화면(전면)에 게시합니다. 다만, 약관의 내용은 이용자가 연결화면을 통하여 볼 수
						있도록 할 수 있습니다.<br> ② “몰은 이용자가 약관에 동의하기에 앞서 약관에 정하여져 있는 내용 중
						청약철회.배송책임.환불조건 등과 같은 중요한 내용을 이용자가 이해할 수 있도록 별도의 연결화면 또는 팝업화면 등을
						제공하여 이용자의 확인을 구하여야 합니다.<br> ③ “몰”은 「전자상거래 등에서의 소비자보호에 관한 법률」,
						「약관의 규제에 관한 법률」, 「전자문서 및 전자거래기본법」, 「전자금융거래법」, 「전자서명법」, 「정보통신망 이용촉진
						및 정보보호 등에 관한 법률」, 「방문판매 등에 관한 법률」, 「소비자기본법」 등 관련 법을 위배하지 않는 범위에서 이
						...
						개정 후 내용을 명확하게 비교하여 이용자가 알기 쉽도록 표시합니다.<br> ⑤ “몰”이 약관을 개정할 경우에는
						...
						규제 등에 관한 법률, 공정거래위원회가 정하는 전자상거래 등에서의 소비자 보호지침 및 관계법령 또는 상관례에 따릅니다.<br>
						<br>부 칙(시행일) 이 약관은 2021년 3월 23일부터 시행합니다.
					</div>
					<div class="checkout__input__checkbox">
						<label for="checkbox2" id="labelCheckbox2"> <span
							style="color: black;">[필수] 개인정보 수집 및 이용 동의</span> <input
							type="checkbox" id="checkbox2" name="checkbox2"> <span
							class="checkmark"></span> <span
							style="color: black; text-decoration: underline; cursor: pointer; text-align: right;"
							onclick="toggleTerms('termsContent2', 'checkbox2')">약관보기</span>
						</label>
					</div>
					<div id="termsContent2" style="display: none;">
						...
						나. 회원 관리<br> &nbsp;회원제 서비스 이용에 따른 본인확인 , 개인 식별 , 불량회원의 부정 이용
						방지와 비인가 사용 방지 , 가입 의사 확인 , 연령확인 , 만14세 미만 아동 개인정보 수집 시 법정 대리인 동의여부
						확인, 불만처리 등 민원처리 , 고지사항 전달<br> 2. 수집하는 개인정보 항목 : 이름 , 로그인ID ,
						비밀번호 , 이메일 , 14세미만 가입자의 경우 법정대리인의 정보<br> 3. 개인정보의 보유기간 및 이용기간<br>
						원칙적으로, 개인정보 수집 및 이용목적이 달성된 후에는 해당 정보를 지체 없이 파기합니다. 단, 다음의 정보에 대해서는
						아래의 이유로 명시한 기간 동안 보존합니다.<br> 가. 회사 내부 방침에 의한 정보 보유 사유<br>
						o 부정거래 방지 및 쇼핑몰 운영방침에 따른 보관 : 5년<br> 나. 관련 법령에 의한 정보보유 사유<br>
						o 계약 또는 청약철회 등에 관한 기록<br> -보존이유 : 전자상거래등에서의소비자보호에관한법률<br>
						-보존기간 : 5년<br> o 대금 결제 및 재화 등의 공급에 관한 기록<br> -보존이유:
						전자상거래등에서의소비자보호에관한법률<br> -보존기간 : 5년<br> o 소비자 불만 또는 분쟁처리에
						관한 기록<br> -보존이유 : 전자상거래등에서의소비자보호에관한법률<br> -보존기간 : 3년<br>
						o 로그 기록<br> -보존이유: 통신비밀보호법<br> -보존기간 : 3개월<br> ※
						동의를 거부할 수 있으나 거부시 회원 가입이 불가능합니다.<br>
					</div>
					<div class="checkout__input__checkbox">
						<label for="checkbox3" id="labelCheckbox3"> <span
							style="color: black;">[선택] 마케팅 활용 동의 및 광고 수신 동의</span> <input
							type="checkbox" id="checkbox3" name="checkbox3"
							onchange="eventYn()"> <span class="checkmark"></span> <span
							style="color: black; text-decoration: underline; cursor: pointer; text-align: right;"
							onclick="toggleTerms('termsContent3', 'checkbox3')">약관보기</span>
						</label>
					</div>
					<div id="termsContent3" style="display: none;">
						할인쿠폰 및 혜택, 이벤트, 신상품 소식 등 쇼핑몰에서 제공하는 정보를 SMS나 이메일로 받아보실 수 있습니다.<br>
						단, 주문/거래 정보 및 주요 정책과 관련된 내용은 수신동의 여부와 관계없이 발송됩니다.<br> 선택 약관에
						동의하지 않으셔도 회원가입은 가능하며, 회원가입 후 회원정보수정 페이지에서 언제든지 수신여부를 변경하실 수 있습니다.
					</div>
    	...
    	$('.id_input').on("propertychange change keyup paste input", function(){
    	    ...
    	    $.ajax({
    	        ...
    	        success : function(result) {
    	            ...
    	            if(result == 'fail') {
    	                $('.id_input_re').css("display","inline");
    	                console.log("1");
    	            } else {
